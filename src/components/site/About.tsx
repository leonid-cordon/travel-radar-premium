      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-lg leading-relaxed mb-6">
            Travel Radar LK AI — это симбиоз многолетнего опыта жизни в Мексике
            и передовых нейросетей. Мы собираем уникальные локации, скрытые жемчужины
            и проверенные рекомендации, а AI помогает каждому путешественнику
            получить персональный маршрут за секунды.
          </p>
          <p className="text-muted-foreground text-lg leading-relaxed mb-8">
            От бирюзовых сенотов Юкатана до колониальных улочек Гуанахуато —
            мы превращаем планирование путешествия в удовольствие.
          </p>
